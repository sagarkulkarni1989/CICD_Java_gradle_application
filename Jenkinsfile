            ...
            steps{
                script{
                    withCredentials([string(credentialsId: 'docker_pass', variable: 'docker_password')]) {
                             sh '''
                                docker build -t 13.233.193.183:8083/springapp:${VERSION} .
                                docker login -u admin -p $docker_password 13.233.193:8083 
                                docker push  13.233.193.183:8083/springapp:${VERSION}
                                docker rmi 13.233.193.183:8083/springapp:${VERSION}
                            '''
                    }
                }
            }
